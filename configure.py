...
config.libs = [ 
    {
        ...
        "objects": [
            Object(Matching, "Runtime/Runtime.PPCEABI.H/global_destructor_chain.c"),
            Object(Matching, "Runtime/Runtime.PPCEABI.H/cpp_eh_runtime.s"),
            Object(Matching, "Runtime/Runtime.PPCEABI.H/__init_cpp_exceptions.cpp"),
            Object(Matching, "Runtime/runtime.c"),
            Object(Matching, "Runtime/runtime2.c"),
        ],
    },
    DolphinLib(
        "card",
    ...
    DolphinLib(
        ...
        [
            ...
            Object(Matching,"dolsdk2004/os/OSSram.c",),
            Object(Matching,"dolsdk2004/os/OSSync.s",),
    ...
    DolphinLib(
        ...
        [
            ...
            Object(Matching, "dolsdk2004/odemu/odestub.c"),
        ],
    ),
    Library(
        "zlib",
    ...
    Library(
        ...
        [
            ...
            Object(Matching,"Runtime/__va_arg.s"),
            ...
            Object(Matching,"Runtime/MSL/Common/scanf.c"),
            ...
            Object(Matching,"Runtime/MSL/Common/ansi_files.c"),
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(Matching, "Alchemy/src/igCore/igArkCoreNew.cpp"),
        ],
    },
    Library(
        "MetroTRK",
        ...
        [
            ...
            Object(Matching, "MetroTRK/console.s"),
            Object(Matching, "MetroTRK/dolphin_trk_comm.s"),
            ...
            Object(Matching, "MetroTRK/ddh_cc.c"),
            Object(Matching, "MetroTRK/ddh_cc_peek.s"),
            Object(Matching, "MetroTRK/ddh_cc2.c"),
            Object(Matching, "MetroTRK/ddh_cc_write.s"),
            Object(Matching, "MetroTRK/ddh_cc_read.s"),
            Object(Matching, "MetroTRK/ddh_cc3.c", cflags=[x for x in cflags_metrotrk if x not in ("-sdata 0", "-sdata2 0")] + ["-sdata 8", "-sdata2 8"]),
            Object(Matching, "MetroTRK/gdev_cc.c"),
            Object(Matching, "MetroTRK/gdev_cc_peek.s"),
            Object(Matching, "MetroTRK/gdev_cc2.c"),
            Object(Matching, "MetroTRK/gdev_cc_write.s"),
            Object(Matching, "MetroTRK/gdev_cc_read.s"),
            Object(Matching, "MetroTRK/gdev_cc3.c", cflags=[x for x in cflags_metrotrk if x not in ("-sdata 0", "-sdata2 0")] + ["-sdata 8", "-sdata2 8"]),
            Object(Matching, "MetroTRK/serpoll.c"),
            Object(Matching, "MetroTRK/serpoll_init.s"),
            Object(Matching, "MetroTRK/serpoll2.c"),
            Object(Matching, "MetroTRK/usr_puts_serial.s"),
            Object(Matching, "MetroTRK/msgbuf_write.s"),
            Object(Matching, "MetroTRK/msgbuf_setpos.c"),
            Object(Matching, "MetroTRK/dbcomm.c"),
            Object(Matching, "MetroTRK/int_handlers.s"),
            Object(Matching, "MetroTRK/serpoll3.s"),
            Object(Matching, "MetroTRK/dispatch2.c"),
            Object(Matching, "MetroTRK/dispatch_stubs.c"),
            Object(Matching, "MetroTRK/dispatch_targetstop.c"),
            Object(Matching, "MetroTRK/dispatch_serialio.s"),
            Object(Matching, "MetroTRK/dispatch_targetcontinue.c"),
            Object(Matching, "MetroTRK/dispatch_setwatchpoint.s"),
            Object(Matching, "MetroTRK/dispatch_events.c"),
            Object(Matching, "MetroTRK/dispatch_events2.s"),
            Object(Matching, "MetroTRK/dispatch_readregs.c"),
            Object(Matching, "MetroTRK/dispatch_readregs2.c"),
            Object(Matching, "MetroTRK/dispatch_writeregs.s"),
            Object(Matching, "MetroTRK/dispatch_writeregs2.s"),
            Object(Matching, "MetroTRK/savegpr.s"),
            Object(Matching, "MetroTRK/trkloadcontext.s"),
            Object(Matching, "MetroTRK/msgbuf_reset.c"),
            Object(Matching, "MetroTRK/msgbuf_senddata.c"),
            Object(Matching, "MetroTRK/msgbuf_read.s"),
            Object(Matching, "MetroTRK/msgbuf_readwrite.c"),
            Object(Matching, "MetroTRK/msgbuf_writevalue.c"),
            Object(Matching, "MetroTRK/trk_trace.c"),
            Object(Matching, "MetroTRK/hwcc_ringbuf.c"),
        ],
    ),
]
