...
config.libs = [ 
    ...
    Library(
        ...
        [
            ...
            Object(Matching, "libpng/pngwrite.c",cflags= cflags_libpng + ["-DPNG_NO_PROGRESSIVE_READ -DPNG_NO_READ_iCCP"],),
            Object(Matching, "libpng/pngwio.c"),
            Object(Matching, "libpng/pngtrans.c"),
            Object(Matching, "libpng/pngset.c",cflags= cflags_libpng + ["-DPNG_NO_READ_iCCP -DPNG_NO_PROGRESSIVE_READ"],),
            Object(NonMatching, "libpng/pngrutil.c",cflags= cflags_libpng + ["-DPNG_NO_READ_iCCP -DPNG_READ_BIG_ENDIAN_SUPPORTED"],),
            Object(Matching, "libpng/pngrtran.c",cflags= cflags_libpng + ["-DPNG_NO_READ_iCCP -DPNG_NO_PROGRESSIVE_READ"],),
            Object(Matching, "libpng/pngrio.c"),
            Object(NonMatching, "libpng/pngread.c",cflags= cflags_libpng + ["-DPNG_NO_READ_iCCP -DPNG_NO_PROGRESSIVE_READ -DPNG_PROGRESSIVE_READ_NOT_SUPPORTED -DPNG_READ_BIG_ENDIAN_SUPPORTED "],),
            Object(Matching, "libpng/pngmem.c",cflags= cflags_libpng + ["-DPNG_NO_READ_iCCP -DPNG_NO_PROGRESSIVE_READ "],),
            Object(Matching, "libpng/pngget.c"),
            Object(Matching, "libpng/pngerror.c"),
            Object(Matching, "libpng/png.c",cflags= cflags_libpng + ["-DPNG_NO_READ_iCCP -DPNG_NO_PROGRESSIVE_READ"],),
        ],
    ),
]
